...
// Metadata must be exported from a server component, so we use a separate export
// For client components, metadata is set via the layout or a parallel route
// We'll handle this via a metadata export in a separate file or inline
        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-gray-300">
              Conversemos sobre tu propiedad. Estamos listos para ayudarte a maximizar
              su potencial en renta corta.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-5 gap-8 lg:gap-12">
              ...
              <Card hover={false} className="!p-8">
                {submitted ? (
                  <div className="text-center py-12">
                    ...
                    <h2 className="heading-3 mb-4">Mensaje enviado</h2>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                      ...
                      <div>
                        ...
                        >
                          ...
                          <option value="evaluacion">Evaluación de propiedad</option>
                          <option value="corretaje">Corretaje / Inversión</option>
                        </select>
                      </div>
                      ...
                      <div>
                        <label htmlFor="propertyDetails" className="block text-sm font-medium text-gray-700 mb-1">
                          Detalles de la propiedad (opcional)
                        </label>
                        <input
                          type="text"
                          id="propertyDetails"
                          ...
                          onChange={handleChange}
                          className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-[#1e3a5f] focus:ring-2 focus:ring-[#1e3a5f]/20 outline-none transition-all"
                          placeholder="Ej: 2BR en Providencia, piso 12, 65m²"
                        />
                      </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <Card hover={false} className="!p-6">
                <h3 className="font-bold text-[#1e3a5f] text-lg mb-4">Información de contacto</h3>
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[#1e3a5f] font-semibold">Santiago, Chile</p>
                    </div>
                  </div>
                </div>
              </Card>
              ...
              {/* Quick Actions */}
              <Card hover={false} className="!p-6">
                <h3 className="font-bold text-[#1e3a5f] text-lg mb-4">Acciones rápidas</h3>
              ...
              <div className="bg-[#1e3a5f]/5 border border-[#1e3a5f]/10 rounded-xl p-5">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-[#1e3a5f] font-semibold text-sm">Tiempo de respuesta</p>
                    <p className="text-gray-500 text-sm">
                      Respondemos dentro de las próximas 24 horas hábiles por email.
                      Por WhatsApp, generalmente en minutos.
                    </p>
                  </div>
                </div>
              </div>
