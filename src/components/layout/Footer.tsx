        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          <div>
            ...
            <div className="flex gap-4 mt-4">
              ...
              <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="text-gray-400 hover:text-white transition-colors">
              ...
              <a href="https://www.linkedin.com/company/mr-bnb" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-gray-400 hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2 text-sm text-gray-300">
                ...
                <a href="mailto:clientes@mrbnb.cl" className="hover:text-white transition-colors">clientes@mrbnb.cl</a>
              </li>
              <li className="flex items-center gap-2 text-sm text-gray-300">
